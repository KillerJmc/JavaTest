...
import com.test.mysql.sorm.info.TableContext;
...
public abstract class Query implements Cloneable {
    ...
    public void insert(Object obj) {
        ...
        for (var f : fs) {
            ...
            Object fieldValue = Reflects.invokeMethod(obj, "get" + Strs.capitalize(fieldName));
    ...
    public void delete(Object obj) {
        ...
        Object priKeyValue = Reflects.invokeMethod(obj, "get" + Strs.capitalize(onlyPriKey.getName()));
    ...
    public int update(Object obj, String... fieldNames) {
        ...
        for (var fName : fieldNames) {
            Object fValue = Reflects.invokeMethod(obj, "get" + Strs.capitalize(fName));
            params.add(fValue);
            sql.append(fName + "=?, ");
        }
        //delete the last ','
        ...
        params.add(Reflects.invokeMethod(obj, "get" + Strs.capitalize(priKey.getName())));
        ...
        return (List<T>) executeQueryTemplate(sql, params, (conn, ps, rs) -> {
            ...
            while (rs.next()) {
                ...
                for (int i = 0; i < metaData.getColumnCount(); i++) {
                    ...
                    if (columnValue != null) {
                        Reflects.invokeMethod(rowObj, "set" + Strs.capitalize(columnName), columnValue);
                    }
                }
                list.add(rowObj);
            }
