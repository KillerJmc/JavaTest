...
import com.test.mysql.orm.sorm.bean.Configuration;
import com.test.mysql.orm.sorm.pool.DBCoonPool;
...
public class DBManager {
    ...
    static {
        ...
        TryUtils.tryThis(() -> pros.load(
            new FileInputStream( "./src/com/test/mysql/orm/sorm/db.properties")));
