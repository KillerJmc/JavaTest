package com.test.mysql.orm.sorm.test;

import com.test.mysql.orm.sorm.core.Query;
import com.test.mysql.orm.sorm.core.QueryFactory;
import com.test.mysql.orm.sorm.core.TableContext;
import com.test.mysql.orm.sorm.po.Dept;
import com.test.mysql.orm.sorm.po.Emp;
import com.test.mysql.orm.sorm.vo.EmpVo;
...
public class Test {
    private static final String sormPath = "./src/com/test/mysql/orm/sorm/";
    ...
    private static void backupTableFields() {
        ...
        try (var oos = new ObjectOutputStream(new FileOutputStream(sormPath + "backup/tables.bak"))) {
    ...
    private static void recoverFromBackup() {
        ...
        try (var ois = new ObjectInputStream(new FileInputStream(sormPath + "backup/tables.bak"))) {
